...
public class SqlUserRepository extends MySqlAbstractRepository implements UserRepository {
    ...
    public class UserWithEmailExistsException extends Exception {
        public UserWithEmailExistsException(String errorMessage) {
            super(errorMessage);
        }
    }
    @Override
    public User addUser(User user) throws UserWithEmailExistsException {
        ...
        if(existingUser != null) {
            ...
            throw new UserWithEmailExistsException("User with that email already exists");
        }
    ...
    public List<User> usersByPage(Integer pageNum) {
        ...
        try {
            connection = newConnection();   //limit-koliko redova da vrati  offset-odakle da krene
